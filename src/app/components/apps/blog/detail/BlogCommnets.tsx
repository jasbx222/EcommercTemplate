          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  <Icon icon="tabler:arrow-back-up" height="18" className="!text-white !shrink-0 rtl:rotate-180" />
                </Button>
              </TooltipTrigger>
              <TooltipContent>
                رد
      ...
      {showReply ? (
        <div className="py-5 px-5">
          <div className="flex gap-3 items-center">
            ...
            <Input className="form-control md:w-full w-fit" placeholder="اكتب ردك..." />
            <Button>رد</Button>
          </div>
        </div>
      ) : (
