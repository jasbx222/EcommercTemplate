...
const RevenueForecast = () => {
  ...
  const optionsBarChart: ApexOptions = {
    ...
    xaxis: {
      categories: ["ينا", "فبر", "مار", "أبر", "ماي", "يون", "يول", "أغس", "سبت"],
  ...
  return (
    <div className="rounded-xl shadow-xs bg-white dark:bg-darkgray p-6 relative w-full words-break">
      <div className="flex justify-between items-center">
        <h5 className="card-title">توقعات الإيرادات</h5>
        ...
        <Select value={selectedPeriod} onValueChange={handleSelectChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="April 2024">أبريل 2024</SelectItem>
            <SelectItem value="May 2024">مايو 2024</SelectItem>
            <SelectItem value="June 2024">يونيو 2024</SelectItem>
          </SelectContent>
        </Select>
      </div>
