...
const ProductRevenue = () => {
  const ProductTableData = [
    ...
    },
    {
      ...
      name: "مشروع تطبيق ويب",
      seller: "ماثيو فلينتوف",
      process: "73.2%",
    ...
    },
    {
      ...
      name: "لوحة تحكم مودرنايز",
      seller: "أنيل كومار",
      process: "73.2%",
      statuscolor: "text-purple-600",
      statusbg: "bg-purple-100",
      statustext: "مرتفع جدًا",
    },
    {
      img: "/matdash-nextjs/images/products/dash-prd-4.jpg",
      name: "شركة داشبورد كو",
      seller: "جورج كرويز",
      process: "73.2%",
      ...
      <ScrollArea className="max-h-[450px]">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="p-6">المسؤول</TableHead>
